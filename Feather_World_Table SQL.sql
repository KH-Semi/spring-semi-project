...
ALTER TABLE TODAY ADD CONSTRAINT TODAY_HOME_FK 
    FOREIGN KEY (HOME_NO) REFERENCES MEMBER(MEMBER_NO) ON DELETE CASCADE;

ALTER TABLE TODAY ADD CONSTRAINT TODAY_VISITOR_FK 
    FOREIGN KEY (VISIT_NO) REFERENCES MEMBER(MEMBER_NO) ON DELETE CASCADE;
...
ALTER TABLE "ILCHON" DROP CONSTRAINT "FK_MEMBER_TO_ILCHON_1";
ALTER TABLE "ILCHON" DROP CONSTRAINT "FK_MEMBER_TO_ILCHON_2";


ALTER TABLE "ILCHON" 
ADD CONSTRAINT "FK_MEMBER_TO_ILCHON_1" 
FOREIGN KEY ("FROM_MEMBER_NO") 
REFERENCES "MEMBER" ("MEMBER_NO") 
ON DELETE CASCADE;

ALTER TABLE "ILCHON" 
ADD CONSTRAINT "FK_MEMBER_TO_ILCHON_2" 
FOREIGN KEY ("TO_MEMBER_NO") 
REFERENCES "MEMBER" ("MEMBER_NO") 
ON DELETE CASCADE;

ALTER TABLE PLAYLIST ADD CONSTRAINT "FK_MEMBER_TO_PLAYLIST"
FOREIGN KEY (MEMBER_NO)
REFERENCES MEMBER (MEMBER_NO)
ON DELETE CASCADE;

ALTER TABLE PROFILE ADD CONSTRAINT "FK_MEMBER_TO_PROFILE" FOREIGN KEY (MEMBER_NO)
REFERENCES MEMBER(MEMBER_NO) ON DELETE CASCADE;

ALTER TABLE "BOARD_TYPE" DROP CONSTRAINT "FK_MEMBER_TO_BOARD_TYPE_1";
